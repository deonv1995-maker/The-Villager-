...
function createWoodcutterHut(){
 ...
 // A proper working cottage: large enough to read as a villager workplace, not a shed.
 ...
 beam(g,-1.05,1.45,-1.71,.15,1.75,.15,.55);beam(g,1.05,1.45,-1.71,.15,1.75,.15,-.55);
 // arched-looking deep doorway assembled from stout posts/header
 ...
 // broad steep roof with thick, rustic overhang
 ...
 add(g,new THREE.BoxGeometry(slope,.18,4.35),roof,[half/2,2.5+rise/2,0],[0,0,-angle]);
 // layered roof strips create the handmade shingle/thatch silhouette.
 ...
 // side lean-to / wood working shelter
 ...
 // stacked firewood is a strong visual identifier from gameplay camera distance.
