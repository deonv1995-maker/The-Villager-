...
import { installEnvironmentVisuals } from './environment-visuals.js?v=049';
import { installWorldCollision } from './world-collision.js?v=048';

await import('./game-v014.js?v=049-runtime');
...
if(version)version.textContent='3D-0.4.9';
...
if(!playerRoot){if(badge)badge.textContent='ROOT?';console.warn('[The Villager] Player root hook unavailable; gameplay fallback remains active.');}
 ...
 const visual=new GlbPlayerVisual({playerRoot,fallbackObjects,modelUrl:`${PLAYER_GLB_CONTRACT.preferredPath}?v=049`,targetHeight:PLAYER_GLB_CONTRACT.targetHeight,localGroundOffset:-0.53});
