...
import { installEnvironmentVisuals } from './environment-visuals.js?v=032';

await import('./game-v014.js?v=032-runtime');
...
if(version)version.textContent='3D-0.3.2';
...
if(!playerRoot){
  ...
  const visual=new GlbPlayerVisual({playerRoot,fallbackObjects,modelUrl:`${PLAYER_GLB_CONTRACT.preferredPath}?v=032`,targetHeight:PLAYER_GLB_CONTRACT.targetHeight,localGroundOffset:-0.53});
