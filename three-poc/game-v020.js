...
await import('./game-v014.js?v=035-runtime');
...
if(version)version.textContent='3D-0.3.5';
...
if(!playerRoot){
  ...
  const visual=new GlbPlayerVisual({playerRoot,fallbackObjects,modelUrl:`${PLAYER_GLB_CONTRACT.preferredPath}?v=035`,targetHeight:PLAYER_GLB_CONTRACT.targetHeight,localGroundOffset:-0.53});
