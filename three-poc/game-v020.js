...
import { installEnvironmentVisuals } from './environment-visuals.js?v=047';
import { installWorldCollision } from './world-collision.js?v=048';

await import('./game-v014.js?v=048-runtime');
...
if(version)version.textContent='3D-0.4.8';
...
if(!playerRoot){if(badge)badge.textContent='ROOT?';console.warn('[The Villager] Player root hook unavailable; gameplay fallback remains active.');}
 ...
 const visual=new GlbPlayerVisual({playerRoot,fallbackObjects,modelUrl:`${PLAYER_GLB_CONTRACT.preferredPath}?v=048`,targetHeight:PLAYER_GLB_CONTRACT.targetHeight,localGroundOffset:-0.53});
