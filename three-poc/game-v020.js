...
await import('./game-v014.js?v=031-runtime');
...
if(version)version.textContent='3D-0.3.1';
...
if(!playerRoot){
  ...
  const visual=new GlbPlayerVisual({playerRoot,fallbackObjects,modelUrl:`${PLAYER_GLB_CONTRACT.preferredPath}?v=031`,targetHeight:PLAYER_GLB_CONTRACT.targetHeight,localGroundOffset:-0.53});
