...
import { installEnvironmentVisuals } from './environment-visuals.js?v=038';

await import('./game-v014.js?v=038-runtime');
...
if(version)version.textContent='3D-0.3.8';
