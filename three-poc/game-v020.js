...
import { installEnvironmentVisuals } from './environment-visuals.js?v=046';

await import('./game-v014.js?v=046-runtime');
...
if(version)version.textContent='3D-0.4.6';
