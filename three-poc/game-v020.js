...
import { installEnvironmentVisuals } from './environment-visuals.js?v=042';

await import('./game-v014.js?v=042-runtime');
...
if(version)version.textContent='3D-0.4.2';
