...
import { installEnvironmentVisuals } from './environment-visuals.js?v=039';

await import('./game-v014.js?v=039-runtime');
...
if(version)version.textContent='3D-0.3.9';
