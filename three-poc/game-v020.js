...
import { installEnvironmentVisuals } from './environment-visuals.js?v=041';

await import('./game-v014.js?v=041-runtime');
...
if(version)version.textContent='3D-0.4.1';
