...
import { installEnvironmentVisuals } from './environment-visuals.js?v=037';

await import('./game-v014.js?v=037-runtime');
...
if(version)version.textContent='3D-0.3.7';
