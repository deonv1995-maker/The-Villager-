...
import { installEnvironmentVisuals } from './environment-visuals.js?v=045';

await import('./game-v014.js?v=045-runtime');
...
if(version)version.textContent='3D-0.4.5';
