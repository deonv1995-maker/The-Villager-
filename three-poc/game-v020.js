...
import { installEnvironmentVisuals } from './environment-visuals.js?v=043';

await import('./game-v014.js?v=043-runtime');
...
if(version)version.textContent='3D-0.4.3';
