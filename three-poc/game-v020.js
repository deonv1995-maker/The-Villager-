...
import { installEnvironmentVisuals } from './environment-visuals.js?v=040';

await import('./game-v014.js?v=040-runtime');
...
if(version)version.textContent='3D-0.4.0';
