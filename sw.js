const CACHE_NAME = 'the-villager-v0.5.2';
const APP_SHELL = [
  './','./index.html','./styles.css?v=0.5.2','./manifest.webmanifest','./icons/icon.svg','./icons/icon-maskable.svg',
  './assets/world-ground-v05.png.base64','./assets/tree-raster.png','./assets/rock-raster.png','./assets/grass-raster.png','./assets/player/player_ranger_walk_v052.png','./assets/player/player_ranger_walk_v052.json',
  './src/game-v03.js?v=0.5.2','./src/art.js?v=0.5.2','./src/config.js','./src/input.js','./src/inventory.js','./src/resources.js','./src/crafting.js','./src/pwa.js?v=0.5.2'
];
